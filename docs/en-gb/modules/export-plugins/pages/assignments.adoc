...
Every assignment needs to implement `UIOptionContract`.

* namespace: `\Plenty\Modules\Catalog\Contracts\UI`

For more details about the option structure, see this page.

We suggest to extend the base assignment `BaseAssignment`.
