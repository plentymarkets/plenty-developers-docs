...
* Option - can take many forms; described in more detail xref:ui-options-in-plugins.adoc[on this page].
...
*Option* classes can take multiple forms and types, for example they can be checkboxes, toggles, dropdown selects and more. Read more about *Option* classes xref:ui-options-in-plugins.adoc[on this page].
...
To learn how to create and use *Options*, check out the xref:ui-options-in-plugins.adoc[documentation].
