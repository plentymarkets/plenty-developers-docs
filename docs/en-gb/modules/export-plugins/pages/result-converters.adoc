...
In your template, you can register result converters as shown below. Note that you could exchange ResultConverterContainer for DefaultResultConverterContainer to enable all predefined converters in your template.:
...
Once you have registered your result converters, the user can select them in the format drop down in the catalogue settings and the Catalogue module will be able to build the file for the user using your specifications in the `convertToDownload` method.
