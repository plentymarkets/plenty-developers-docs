...
In this class you need to create two methods, `applyDynamicConfig()` and `applyDynamicPreviewConfig()`. These methods receive identical parameters: the xref:stable7@docs-raw::Catalog.adoc#catalog_models_catalog[catalog], the xref:stable7@docs-raw::Catalog.adoc#catalog_contracts_templatecontract[template] and an instance of xref:stable7@docs-raw::Catalog.adoc#catalog_contracts_catalogexportservicecontract[CatalogExportService].
