...
* [ ] Have you added the corresponding SSR directives outlined above?
* [ ] Did you make sure you did not include any logic in the `created()` hook, as specified in the link:https://ssr.vuejs.org/guide/universal.html#component-lifecycle-hooks[Vue documentation]?
* [ ] Are all HTML tags closed properly?
