...
b. In modules you need to load them in `boot()` method of your *ServiceProvider*. +
...
|topics:string[] // [‘multichannel.amazon’, ‘Amazon Vendor’]
|required; must contain one topic which describes the domain of the settings in plentymarkets system; can contain additional topics
