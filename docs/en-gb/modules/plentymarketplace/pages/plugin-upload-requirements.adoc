...
|1
|The preview images of the plugin. For further information, refer to link:#marketplace-metadata[Other meta data].

|2
|The user guide of the plugin. For further information, refer to link:#marketplace-user-guide[User guide].

|3
|The change log of the plugin. For further information, refer to link:#marketplace-changelog[Change log].

|4
|The support contact data of the plugin. For further information, refer to link:#marketplace-support-contact[Support contact data].

|5
|The plugin icon. For further information, refer to link:#marketplace-metadata[Other meta data]. The plugin icon is also displayed in the *Plugins » Plugin overview* menu of the plentymarkets back end. The icon path must be specified in the `plugin.json`.
|===
...
For further information, refer to link:#marketplace-pluginjson[Plugin data].
|===
