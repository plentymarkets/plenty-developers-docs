...
The plentyMarketplace is a huge success. We currently have more than 100 plugins developed by plentymarkets and a dozen providers (both steadily growing!). With such a huge portfolio, certain challenges arise. To meet these challenges, this document provides guidelines for code review, user guide experience and other important aspects of plugin and tool content in addition to the basic link:/marketplace/plugin-requirements[plugin requirements] and
link:/marketplace/plugin-upload[upload guide]. Be advised that the plentymarkets reviewers will check any software thoroughly to make sure these standards are met.

*Note* that before you can upload plugins to plentyMarketplace, you need to become a link:https://www.plentymarkets.co.uk/service/our-partners/[plentyMarketplace partner]. To become a partner, submit the contact form on https://www.plentymarkets.eu/service/partner-werden/[here] (German) or https://www.plentymarkets.co.uk/company/be-our-plentymarketplace-partner/[here] (English).
...
Plugins have to use the link:/terra-doc/components[terra components] in their back end UI.
...
Saving delivery and export documents must use link:/api-doc/Document[DocumentRepository].
