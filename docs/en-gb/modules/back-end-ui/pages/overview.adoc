...
The following entries and their explanations provide more detailed information on the specific properties of your plugin's menu entries.
...
A list of all routes that can be accessed by plugins can be found here: LINK. +
