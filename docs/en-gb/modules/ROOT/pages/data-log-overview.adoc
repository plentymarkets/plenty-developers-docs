...
// @TODO Replace link.
|Message
|Detailed information on the logged event. For the log levels `warning` and below, the message has to be link:/dev-doc/plugin-multilingualism[available in English _and_ German]. [red]#required#
