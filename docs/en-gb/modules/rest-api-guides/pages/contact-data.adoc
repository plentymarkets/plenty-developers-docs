...
After you retrieved the data as described in link:#retrieve-basic-information[Retrieve basic information], you can create a new contact. To put it simply, a contact is nothing else than a natural person. Use the following REST call to create a contact.
